...
echo "INFO: --- Gadget Subface Camera (RGB & IR) ---"
...
echo "Subface Camera"       > "${GADGET_PATH}/strings/0x409/product"
echo 202102190001           > "${GADGET_PATH}/strings/0x409/serialnumber"
...
echo "UVC Configuration" > "${GADGET_PATH}/configs/c.1/strings/0x409/configuration"
...
# UVC functions (IR)
FUNCTIONS_UVC_IR="${GADGET_PATH}/functions/uvc.usb1"
...
ln -s    "${FUNCTIONS_UVC_IR}"                          "${GADGET_PATH}/configs/c.1/uvc.usb1"
